...
import Amazon_POM.CouponCode_13;
...
public class Testcase13 extends Launch_Quit1 {
	...
	public void Checkout() throws EncryptedDocumentException, IOException, InterruptedException
	{
		...
		CouponCode_13 cc1=new CouponCode_13(driver);
		cc1.box();
		//cc1.apply1();
		WebElement w6=	cc1.box1();
	boolean b9=	w6.isEnabled();
	Assert.assertEquals(b9, true, "failed");
